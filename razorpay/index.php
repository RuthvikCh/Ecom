                    ...
                    <form  method="post" action="payment.php">
                      <div class="form-row">
                        <div class="col-lg-5 col-12">
                          <input type="text"  name="firstname" class="form-control form-control-sm formstyle" placeholder="First name" required>
                        </div>
                        <div class="col-lg-7 col-12">
                          <input type="text" name="lastname" class="form-control form-control-sm formstyle" placeholder="Last name"required >
                        </div>
                      </div>
                      <div class="form-row">
                        <div class="col-lg-5 col-12">
                      <input type="text"  name="phone" class="form-control form-control-sm formstyle" placeholder="Phone Number" minlength="10" maxlength="10" required>
                      </div>
                      <div class="col-lg-7 col-12">
                        <input type="email" name="email" class="form-control form-control-sm formstyle" placeholder="Email" required>
                        </div>
                      </div>
                      <div class="form-row">
                        <div class="col-lg-5 col-12">
                      <!-- <input type="tel"  name="pincode"  formstyle" placeholder="Pincode" maxlength="6" minlength="6"  required> -->
                      <!-- <input type="text"  name="pincode" class="form-control form-control-sm formstyle" maxlength="6" minlength="6" placeholder="Pincode" required> -->
                      <input type="text" class="form-control form-control-sm" name="pincode" placeholder="Enter Pincode" required pattern="^[0-9]{6}$" title="Enter Valid Pin Code"> 
                    </div>
                    <div class="col-lg-7 col-12">
                      <input type="text" maxlength="185" name="address" class="form-control form-control-sm formstyle" placeholder="Locality" required>
                    </div>
                    </div>
                   
                    <div class="form-row">
                      <div class="col-lg-5 col-12">
                      <input type="text" maxlength="185"  name="addr2" class="form-control form-control-sm formstyle" placeholder="landmark" required>
                    </div>
                    <div class="col-lg-7">
                      <input type="text"  name="city" class="form-control form-control-sm formstyle" placeholder="City" required>
                    </div>
                  </div>
                    <div class="form-row">
                      <div class="col-lg-5 col-12">
                    <input type="text"  name="state" class="form-control form-control-sm formstyle" placeholder="State" required>
                  </div>
                  <div class="col-lg-7 col-12">
                    <input type="text" name="country" class="form-control form-control-sm formstyle" placeholder="Country" required>
                  </div>
                  </div>
                  <input type="text" class="form-control form-control-sm formstyle" value="<?php echo $totalprice ?>" name="amt" readonly>
