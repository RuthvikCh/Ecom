...
<div class="bg-image">
  <div class="header-text">
    ...
    <h1>SNKRS</h1>
    <div class="bannerbtn">
      <a href="store.php" class="gsans" ><span></span>SHOP NOW</a>
...
<section id="features">
  ...
  <div class="row">
    ...
    <div class="col-md-6 col-12 bmargin"  >
      <center>
      <span class="iconify material-icons icons" style="font-size: 75px;" data-icon="fa-solid:running"></span>
      <h2> Comfortable </h2>
      </center>
    </div>
    <div class="col-md-6 col-12 bmargin"  >
      <center>
        <span class="iconify material-icons icons" style="font-size: 75px; " data-icon="bx:water"></span>
    ...
    <div class="col-md-6 col-12  bmargin"  >
      <center>
      <span class="iconify material-icons icons" style="font-size: 75px; "" data-icon="material-symbols:workspace-premium-outline-rounded"></span>
      <h2>Premium cloth</h2>
      </center>
    </div>
    <div class="col-md-6 col-12  bmargin "  >
      <center>
      <span class="iconify material-icons icons" style="font-size: 75px; " data-icon="ion:layers-sharp"></span>
